 ...
 * @author xiaoqiao
 * @version V1.0
 * @Description 邮件消费者  交换机类型 Direct   路由模式RoutingKey
 * @date 2019/5/25 9:30
 */
public class EmailConsumerRouting {
    /**
     * 定义队列名称
     */
    private static final String EMAIL_QUEUE = "email_queue_routingKey";
    /**
     * 定义交换机名称
     */
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //因为消费者只绑定了routingKey=email 所以生产者投递消息，只有邮件l队列可以拿到消息，短信队列是拿不到消息的。
