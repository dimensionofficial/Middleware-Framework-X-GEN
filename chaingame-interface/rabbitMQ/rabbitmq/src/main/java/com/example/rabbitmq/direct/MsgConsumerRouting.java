 ...
 * @author xiaoqiao
 * @version V1.0
 * @Description 短信消费者  交换机类型 Direct   路由模式RoutingKey
 * @date 2019/5/25 9:40
 */
public class MsgConsumerRouting {

    /**
     * 定义队列名称
     */
    private static final String MSG_QUEUE = "msg_queue_routingKey";
    /**
     * 定义交换机名称
     */
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //4.消费者队列绑定交换机  第一个参数：队列名称  第二个参数：交换机名称  第三个参数：路由键名称(生产者中定义的路由键)
        // 这里绑定了二个路由键 所以生产者投递消息不管是邮件队列还是短信队列都可以收到消息。
        channel.queueBind(MSG_QUEUE, EXCHANGE_NAME, "msg");
        channel.queueBind(MSG_QUEUE, EXCHANGE_NAME, "email");
        //5.消费者监听消息
