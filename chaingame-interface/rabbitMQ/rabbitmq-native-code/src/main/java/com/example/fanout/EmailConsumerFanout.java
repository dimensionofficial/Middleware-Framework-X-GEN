 ...
 * @author xiaoqiao
 * @version V1.0
 * @Description 发布订阅 Fanout 类型  邮件消费者
 * @date 2019/12/5 22:50
 */
public class EmailConsumerFanout {
    /**
     * 邮件队列名称
     */
    public static final String QUEUE_NAME = "order_fanout_consumer_email";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        System.out.println("Fanout类型 邮件消费者启动...");
        //1.创建连接
